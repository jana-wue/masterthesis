...
OUTPUT_PNG = OUTPUT_DIR / "llm_method_rank_heatmap.png"
OUTPUT_PDF = OUTPUT_DIR / "llm_method_rank_heatmap.pdf"
OUTPUT_CSV = OUTPUT_DIR / "llm_method_rank_heatmap_table.csv"
...
def _plot_heatmap(rank_matrix: pd.DataFrame, tasks: list[tuple[str, str]]) -> None:
    ...
    fig_width = max(10, len(tasks) * 0.9)
    fig_height = 5.3
...
def main() -> None:
    ...
    print("=" * 80)
    print("LLM METHOD RANK HEATMAP WRITTEN")
    print("=" * 80)
