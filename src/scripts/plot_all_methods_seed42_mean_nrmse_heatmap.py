...
OUTPUT_PNG = OUTPUT_DIR / "all_methods_seed42_mean_nrmse_heatmap.png"
OUTPUT_PDF = OUTPUT_DIR / "all_methods_seed42_mean_nrmse_heatmap.pdf"
OUTPUT_CSV = OUTPUT_DIR / "all_methods_seed42_mean_nrmse_heatmap_table.csv"
...
def _plot_heatmap(metric_matrix: pd.DataFrame, tasks: list[tuple[str, str]]) -> None:
    ...
    fig_width = max(10.5, len(tasks) * 0.92)
    fig_height = 7.2
    ...
    fig.suptitle("All Methods on Shared Seed-42 Tasks: Mean NRMSE", fontsize=20, y=0.965)
    ax.set_xlabel("")
    ax.set_ylabel("")
...
def main() -> None:
    ...
    print("=" * 80)
    print("ALL METHODS SEED-42 MEAN NRMSE HEATMAP WRITTEN")
    print("=" * 80)
